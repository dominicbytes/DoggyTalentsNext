...
for (let x = 0; x < 16; ++x) for (let z = 0; z < 16; ++z) {
    blocks.push({pos: {type: 'list', value: {type: 'int', value: [x, 0, z]}}, state: {type: 'int', value: 0}});
}
const tag = {type: 'compound', name: '', value: {
    DataVersion: {type: 'int', value: 4790},
    size: {type: 'list', value: {type: 'int', value: [16, 6, 16]}},
    palette: {type: 'list', value: {type: 'compound', value: [{Name: {type: 'string', value: 'minecraft:stone'}}]}},
