...
import doggytalents.client.entity.model.accessories.FieryReflectorModel;
...
public class FieryReflectorRenderEntry extends Entry {
    ...
    public static final ModelLayerLocation FIERY_REFL = new ModelLayerLocation(Util.getResource("fiery_reflector"), "main");
