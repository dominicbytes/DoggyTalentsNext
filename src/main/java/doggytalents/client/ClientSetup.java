...
public class ClientSetup {
    ...
    public static final ModelLayerLocation DOG_IWANKO = new ModelLayerLocation(Util.getResource("dog_iwanko"), "main");
    public static final ModelLayerLocation DOG_LUCARIO = new ModelLayerLocation(Util.getResource("dog_lucario"), "main");
    public static final ModelLayerLocation DOG_DEATH = new ModelLayerLocation(Util.getResource("dog_death"), "main");    
    public static final ModelLayerLocation DOG_LEGOSHI = new ModelLayerLocation(Util.getResource("dog_legoshi"), "main");    
    public static final ModelLayerLocation DOG_JACK = new ModelLayerLocation(Util.getResource("dog_jack"), "main");   
    public static final ModelLayerLocation DOG_JUNO = new ModelLayerLocation(Util.getResource("dog_juno"), "main");   
    public static final ModelLayerLocation DOG_ST_BERNARD = new ModelLayerLocation(Util.getResource("dog_st_bernard"), "main");   

    public static final ModelLayerLocation OKAMI_AMATERASU = new ModelLayerLocation(Util.getResource("okami_amaterasu"), "main");
    public static final ModelLayerLocation AMMY_CHI = new ModelLayerLocation(Util.getResource("ammy_divine_chi"), "main");
    public static final ModelLayerLocation AMMY_JIN = new ModelLayerLocation(Util.getResource("ammy_divine_jin"), "main");
    public static final ModelLayerLocation AMMY_REBIRTH = new ModelLayerLocation(Util.getResource("ammy_divine_rebirth"), "main");
    public static final ModelLayerLocation AMMY_REI = new ModelLayerLocation(Util.getResource("ammy_divine_rei"), "main");
    public static final ModelLayerLocation AMMY_SHIN = new ModelLayerLocation(Util.getResource("ammy_divine_shin"), "main");
    public static final ModelLayerLocation AMMY_SHIRANUI = new ModelLayerLocation(Util.getResource("ammy_divine_shiranui"), "main");
    public static final ModelLayerLocation AMMY_TEI = new ModelLayerLocation(Util.getResource("ammy_divine_tei"), "main");
