...
public class DoggyEntityTypes {
    ...
    public static final Supplier<EntityType<Dog>> DOG = register("dog", Dog::new, MobCategory.CREATURE, (b) -> b
            .sized(0.6F, 0.85F)
            .setUpdateInterval(3)
            .setTrackingRange(16)
            .setShouldReceiveVelocityUpdates(true));

    public static final Supplier<EntityType<DoggyBeamEntity>> DOG_BEAM = register("dog_beam", DoggyBeamEntity::new, MobCategory.MISC, (b) -> b
            .sized(0.25F, 0.25F)
            .setUpdateInterval(4)
            .setTrackingRange(10)
            .setShouldReceiveVelocityUpdates(true)
    ...
    public static final Supplier<EntityType<Piano>> GRAND_PIANO_WHITE = register("grand_piano_white", (type, level) -> new Piano(type, level, PianoType.GRAND, PianoColor.WHITE), MobCategory.MISC,
        b -> b
            .sized(3f, 3f)
            .setUpdateInterval(4)
            .setTrackingRange(10)
    ...
    public static final Supplier<EntityType<Piano>> UPRIGHT_PIANO_BLACK = register("upright_piano_black", (type, level) -> new Piano(type, level, PianoType.UPRIGHT, PianoColor.BLACK), MobCategory.MISC,
        b -> b
            .sized(3f, 3f)
            .setUpdateInterval(4)
            .setTrackingRange(10)
    ...
    public static final Supplier<EntityType<Piano>> UPRIGHT_PIANO_BROWN = register("upright_piano_brown", (type, level) -> new Piano(type, level, PianoType.UPRIGHT, PianoColor.BROWN), MobCategory.MISC,
        b -> b
            .sized(3f, 3f)
            .setUpdateInterval(4)
            .setTrackingRange(10)
